        ...
        switch ($_REQUEST['funcion']) {
            ...
            case 'consultarContratos':
                ...
                if ($comisionador == true) {
                    $cadena = "AND ac.id_comisionador='" . $idusuario . "'";
                }

                $cadenaSql = $this->sql->getCadenaSql('consultarContratos', $cadena);
                echo $cadenaSql;exit;
                ...
                if ($resultadoContratos) {
                    ...
                    foreach ($resultadoContratos as $key => $valor) {
                        ...
                        $resultadoFinal[] = array(
                            ...
                            'identificacionBeneficiario' => "<center>" . $valor['identificacion'] . " " . $valor['nombre_beneficiario'] . "</center>",
