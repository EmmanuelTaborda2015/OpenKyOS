	...
	public function getCadenaSql($tipo, $variable = '') {
		...
		switch ($tipo) {
			...
			case 'registrarMasivo' :
				$cadenaSql = " INSERT INTO interoperacion.enlace_masivo(";
				$cadenaSql .= " tipo_masivo,";
				$cadenaSql .= " ruta, ";
				$cadenaSql .= " nombre_archivo, ";
				$cadenaSql .= " usuario)";
				$cadenaSql .= " VALUES ('" . $variable ['tipo_masivo'] . "',";
			...
			case 'consultarMasivo' :
				$cadenaSql = " SELECT * FROM interoperacion.enlace_masivo";
				$cadenaSql .= " WHERE";
				$cadenaSql .= " usuario='" . $info_usuario ['uid'] [0] . "' ORDER BY consecutivo DESC;";
				break;
